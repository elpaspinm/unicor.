...
const PharmacistPublicationsPage = () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        {currentSection === 'interactions' && (
          <PublicationChat chatKey="interactions_chat" title="Chat de Posibles Interacciones" canSendMessages={true} />
        )}
        {currentSection === 'alerts' && (
          <PublicationChat chatKey="alerts_chat" title="Chat de Alertas Farmacéuticas" canSendMessages={true} />
        )}
      </div>
    </div>
  );
...
export default PharmacistPublicationsPage;